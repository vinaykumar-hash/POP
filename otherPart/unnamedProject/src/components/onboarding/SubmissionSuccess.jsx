...
export default function SubmissionSuccess({ listingData }) {
  return (
      ...
      <div className="success-card">
        ...
        <div className="success-explanation-box">
          ...
          <p className="success-subtext">
            You'll be able to manage your listing from My Parking once it has been approved. Listings are not made publicly bookable until verified.
          </p>
        </div>
