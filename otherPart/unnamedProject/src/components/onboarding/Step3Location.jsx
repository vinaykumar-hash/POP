...
export default function Step3Location({ data, onChange, onContinue, onBack }) {
  ...
  const handleMapPinClick = (e) => {
    const rect = e.currentTarget.getBoundingClientRect();
    const x = e.clientX - rect.left;
    const y = e.clientY - rect.top;
    
    // Simulate realistic coordinate adjustment around base center (e.g. Mumbai / Metro area)
      ...
      <div className="form-card">
        ...
        <div className="form-group">
          ...
          <input
            ...
            placeholder="e.g. Flat 402, Green Acres Society, Linking Road"
        ...
        <div className="form-row-2">
          ...
          <div className="form-group">
            ...
            <input
              ...
              aria-required="true"
              aria-invalid={!!(touched.locality && errors.locality)}
            />
        ...
        <div className="form-group" style={{ marginTop: '0.5rem' }}>
          <div className="label-with-badge">
            <label className="form-label" style={{ marginBottom: 0 }}>
              Pinpoint Entrance Location (Placeholder Selector)
            </label>
            ...
            onKeyDown={(e) => {
              if (e.key === 'Enter' || e.key === ' ') {
                handleMapPinClick({
                  ...
                  clientX: e.currentTarget.getBoundingClientRect().left + 150,
                  clientY: e.currentTarget.getBoundingClientRect().top + 100
                });
              }
            }}
          >
            ...
            <div className="map-overlay-tag">
              Map Placeholder &bull; Coordinates: {location.latitude}, {location.longitude}
            </div>
          </div>
        </div>
      </div>
