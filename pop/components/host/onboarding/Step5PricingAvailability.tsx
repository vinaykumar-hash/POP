...
interface Step5PricingAvailabilityProps {
  data: ParkingListing;
...
export default function Step5PricingAvailability({
  data,
  onChange,
  onContinue,
  onBack,
}: Step5PricingAvailabilityProps) {
  ...
  const handlePricingChange = (field: 'hourly' | 'daily', val: string) => {
    onChange({
      ...data,
      pricing: {
        ...pricing,
