    ...
    <form className="step-form-container" onSubmit={handleSubmit} noValidate>
      <div className="step-header">
        ...
        <p className="step-subtitle">
          {isVerified
            ? 'Your host account identity is verified on file with POP Administration.'
            : isPending
                ...
                <div className="uploaded-file-card">
                  <div className="file-info-left">
                    ...
                    <div>
                      ...
                      <p className="file-meta">{(data.verification.document.size / (1024 * 1024)).toFixed(2)} MB &bull; Ready for submission</p>
                    </div>
                  </div>
                  <button
                    type="button"
